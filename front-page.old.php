<?php get_header(); ?>
    <div class="front-page">
        <?php if (have_posts()): while (have_posts()): the_post(); ?>
            ...
            <div class="parallax-window parallax-full-height top-parallax" data-parallax="scroll" data-speed="0.5" data-image-src="<?= $image['url']; ?>"></div>
                                  ...
                                  <?php if( have_rows('page_box') ): ?>
                                    <div class="row third-split">
                                      <?php while ( have_rows('page_box') ) : the_row(); ?>
                                        ...
                                        <div class="third page-box" style="background-image:url(<?= $bgImage['url'] ?>);">
            ...
            <div class="parallax-window parallax-full-height bottom-parallax" data-parallax="scroll" data-speed="0.5" data-image-src="<?= $image['url']; ?>"></div>
        <?php endwhile; endif; ?>
    </div>
<?php get_footer(); ?>
